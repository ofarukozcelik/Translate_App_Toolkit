  ...
  return (
    <div className="bg-zinc-900 h-screen text-white grid place-items-center">
      <div className="w-[80vw] max-w-[1100px] flex flex-col justify-center">
        <h1 className="text-center mb-7 text-4xl font-semibold ">Translate</h1>
        ...
        <div className="flex gap-2 text-black">
          ...
          <button
            onClick={handleSwap}
            className="text-white text-[25px] bg-zinc-700 px-6 rounded hover:ring-2 hover:bg-zinc-800"
          >
            ⇆
          </button>
          <Select
